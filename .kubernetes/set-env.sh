...
if [ -z "${SERVER_SSO_DATABASE_USERNAME}" ]; then
    export SERVER_SSO_DATABASE_USERNAME=${NAMESPACE}_sso
fi
if [ -z "${SERVER_SSO_DATABASE_NAME}" ]; then
    export SERVER_SSO_DATABASE_NAME=${NAMESPACE}_sso
fi

# server: notifications database
if [ -z "${SERVER_NOTIFICATIONS_DATABASE_PASSWORD}" ]; then
    export SERVER_NOTIFICATIONS_DATABASE_PASSWORD=notifications_password
fi
if [ -z "${SERVER_NOTIFICATIONS_DATABASE_USERNAME}" ]; then
    export SERVER_NOTIFICATIONS_DATABASE_USERNAME=${NAMESPACE}_notifications
fi
if [ -z "${SERVER_NOTIFICATIONS_DATABASE_NAME}" ]; then
    export SERVER_NOTIFICATIONS_DATABASE_NAME=${NAMESPACE}_notifications
fi

# server: two factor database
if [ -z "${SERVER_TWO_FACTOR_DATABASE_PASSWORD}" ]; then
    export SERVER_TWO_FACTOR_DATABASE_PASSWORD=two_factor_password
fi
if [ -z "${SERVER_TWO_FACTOR_DATABASE_USERNAME}" ]; then
    export SERVER_TWO_FACTOR_DATABASE_USERNAME=${NAMESPACE}_two_factor
fi
if [ -z "${SERVER_TWO_FACTOR_DATABASE_NAME}" ]; then
    export SERVER_TWO_FACTOR_DATABASE_NAME=${NAMESPACE}_two_factor
fi
