...
import { MetricsGithubMetricDtoInterface } from '@site15/rest-sdk-angular';
...
export class MetricsGithubMetricMapperService {
  constructor(protected readonly translocoService: TranslocoService) {}

  toModel(item?: MetricsGithubMetricDtoInterface): MetricsGithubMetricModel {
    return {
      ...item,
