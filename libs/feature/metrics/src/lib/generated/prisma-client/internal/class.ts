...
/**
  ...
  /**
   * `prisma.metricsSettings`: Exposes CRUD operations for the **MetricsSettings** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more MetricsSettings
    * const metricsSettings = await prisma.metricsSettings.findMany()
    * ```
    */
  get metricsSettings(): Prisma.MetricsSettingsDelegate<ExtArgs, ClientOptions>;

  /**
   * `prisma.metricsDynamic`: Exposes CRUD operations for the **MetricsDynamic** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more MetricsDynamics
    * const metricsDynamics = await prisma.metricsDynamic.findMany()
    * ```
    */
  get metricsDynamic(): Prisma.MetricsDynamicDelegate<ExtArgs, ClientOptions>;

  /**
   * `prisma.metricsDynamicCache`: Exposes CRUD operations for the **MetricsDynamicCache** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more MetricsDynamicCaches
    * const metricsDynamicCaches = await prisma.metricsDynamicCache.findMany()
    * ```
    */
  get metricsDynamicCache(): Prisma.MetricsDynamicCacheDelegate<ExtArgs, ClientOptions>;

  /**
   * `prisma.metricsDynamicHistory`: Exposes CRUD operations for the **MetricsDynamicHistory** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more MetricsDynamicHistories
    * const metricsDynamicHistories = await prisma.metricsDynamicHistory.findMany()
    * ```
    */
  get metricsDynamicHistory(): Prisma.MetricsDynamicHistoryDelegate<ExtArgs, ClientOptions>;
}
