...
export interface MetricsGithubMetricsControllerFindMany400ResponseInterface { 
    /**
...
export namespace MetricsGithubMetricsControllerFindMany400ResponseInterface {
}
