...
export class Site15RestClientApiModule {
    public static forRoot(configurationFactory: () => Site15RestClientConfiguration): ModuleWithProviders<Site15RestClientApiModule> {
        return {
    ...
    constructor( @Optional() @SkipSelf() parentModule: Site15RestClientApiModule,
