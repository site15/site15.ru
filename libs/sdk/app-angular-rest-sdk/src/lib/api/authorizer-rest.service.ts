...
// @ts-ignore
import { AuthorizerClientIDInterface } from '../model/authorizer-client-id.interface';
...
export class AuthorizerRestService {
  ...
  ): Observable<AuthorizerClientIDInterface>;
  public authorizerControllerGetAuthorizerClientID(
    observe?: 'response',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpResponse<AuthorizerClientIDInterface>>;
  public authorizerControllerGetAuthorizerClientID(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<AuthorizerClientIDInterface>>;
  public authorizerControllerGetAuthorizerClientID(
    observe: any = 'body',
    ...
    let localVarPath = `/api/authorizer/client-id`;
    return this.httpClient.request<AuthorizerClientIDInterface>(
      'get',
